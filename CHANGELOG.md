...
* feat!: Add region support (#65) @fatbasstard

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-aurora/compare/v4.4.1...v5.0.0
...
* fix: removed duplicate required providers config (#64) @thulasirajkomminar

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-aurora/compare/v4.4.0...v4.4.1
...
* feat: updating to new mcaf-role (#63) @macampo

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-aurora/compare/v4.3.1...v4.4.0
